...
app.layout = html.Div( [
    ...
    dcc.RadioItems(['pop','lifeExp','gdpPercap'],'pop',inline=True,id='radioitems'),
    dcc.Dropdown(df.country.unique(),value='Taiwan',id='dropdown-selection'),dash_table.DataTable(data=[],page_size=10,id='datatable',columns=[{'id':'country','name':'country'},
    {'id':'year','name':'year'},
    {'id':'pop','name':'pop'}]),
